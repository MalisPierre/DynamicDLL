...
namespace StaticModule.InputManager
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        public bool CheckMouseRightMove()
        {
        ...
        public bool CheckMouseLeftMove()
        {
            if (Input.GetAxis("Mouse X") < 0)
                return true;
            else
        ...
        public bool CheckMouseDownMove()
        {
            if (Input.GetAxis("Mouse Y") < 0)
                return true;
            else
